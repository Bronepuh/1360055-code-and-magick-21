...
var fireballSize = 22;
var getFireballSpeed = function (isMovingRight) {
  if (isMovingRight) {
    return 2;
  } else {
    return 5;
...
var getWizardX = function (windowWidth) {
  return (windowWidth - wizardWidth) / 2;
};
var getWizardY = function (windowHeight) {
  return windowHeight - windowHeight / 3 - getWizardHeight();
};
